...
def add_model_config_args(parser):
    ...
    group.add_argument('--make-vocab-size-divisible-by', type=int, default=8,
    ...
    group.add_argument('--sparse-mode', type=str, default='all',
                       choices=['all', 'alternating', 'top_bottom'],
                       help='sparse layers arrangement in model')
...
def add_training_args(parser):
    ...
    group.add_argument('--min-lr', type=float, default=1.0e-6,
    ...
    group.add_argument('--log-memory', action='store_true',
                       help='Write memory consumption in tensorboard log')
    group.add_argument('--no-load-rng', action='store_true',
                       help='Do not load rng state when loading checkpoint.')
    group.add_argument('--load-huggingface', type=str, default=None,
                       help='Path to a directory containing a huggingface transformers model checkpoint.')
    group.add_argument('--export-huggingface', type=str, default=None,
                       help='Exported model to path in huggingface format.')
    group.add_argument('--huggingface-double-pos-embeddings', action='store_true',
                       help='Duplicate first half of pos embedding weights to last')
    group.add_argument('--load-tag', type=str, default='',
                       help='checkpoint name to test')
    group.add_argument('--cache-prefix', type=str, default='_',
                       help='cache folder prefix')
    ...
    group.add_argument('--master_port', type=int, default=6000,
                       help='master port for test parallel prediction')
...
def add_text_generate_args(parser):
    ...
    group.add_argument("--tg-token-name", type=str, default='token.txt')
    return parser
...
def add_data_args(parser):
    ...
    group.add_argument('--max-files-per-process', type=int, default=50000,
                       help="Maximum files to load per process")
