...
gpt_options=" \
       --train-data-path /home/jovyan/runormas/data/train_new_raw14/files.list \
       --max-files-per-process 20000 \
       --logging-dir=/home/jovyan/runormas/models/xl/runs_v14/ \
       --load /home/jovyan/runormas/models/xl/v14/ \
       --save /home/jovyan/runormas/models/xl/v14/ \
